# Django settings for parker_demo project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_ROOT, 'local_db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '!#$=kxq5=$!*q*zm-(*nkk&amp;a4lyb)twj+7eiay35(%2d9hjaqw'
